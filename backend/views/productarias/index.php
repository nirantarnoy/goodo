            ...
            <div style="width: 100%;height: 50px;background-color: #ffffff">
                ...
                <div class="pull-left">
                    <ul class="header-menu" style="float: left;list-style: none;padding: 0;height: 50px;">
                        <li><a href="<?= yii\helpers\Url::to("index.php?r=productarias/create") ?>"><i class="fa fa-paste"></i> Create</a> </li>
                    </ul>
                </div>
              ...
              //  'filterModel' => $searchModel,
                'columns' => [
                   ...
                   [
                     'attribute'=>'productid',
                     'value'=>function($data){
                        return $data->productid!=''?$data->product->prodname:'';
                     }
                   ],
//                    'vendorid',
                    [
                        'attribute'=>'vendorid',
                        'value'=>function($data){
                            return $data->vendorid!=''?$data->aliasname->vendorname:'';
                        },
                    ],
                    'ariasname',
                    'detail',
