...
/* @var $searchModel backend\models\PurchaseTableSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Purchase Orders';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="purchase-table-index">
            ...
            <div style="width: 100%;height: 50px;background-color: #ffffff">
                ...
                <div class="pull-left">
                    <ul class="header-menu" style="float: left;list-style: none;padding: 0;height: 50px;">
                        <li><a href="<?= yii\helpers\Url::to("index.php?r=purchasetable/create") ?>"><i class="fa fa-paste"></i> Create</a> </li>
                       <li><a href="<?= yii\helpers\Url::to("index.php?r=purchasetable/create") ?>"><i class="fa fa-paste"></i> Cancel</a> </li>
                        <li><a href="<?= yii\helpers\Url::to("index.php?r=purchasetable/create") ?>"><i class="fa fa-paste"></i> Purchase Receive</a> </li>
                        <li><a href="<?= yii\helpers\Url::to("index.php?r=purchasetable/create") ?>"><i class="fa fa-paste"></i> Purchase History</a> </li>
                    </ul>
                </div>
