...
/**
 * This is the model class for table "salequotationline".
 *
 ...
 */
class Salequotationline extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['saleid', 'prodid', 'unit', 'prrefid', 'warehouseid', 'loctionid', 'lotid', 'serialid', 'status'], 'integer'],
