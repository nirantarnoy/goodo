...
class Product extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['netweight', 'tareweight', 'grossweight', 'height', 'width', 'dept', 'density', 'minstock', 'maxstock', 'minorder', 'maxorder', 'multiple', 'cost', 'minorder1', 'maxorder1', 'multiple1', 'minorder2', 'maxorder2', 'multiple2', 'purchprice', 'saleprice'], 'number'],
            [['costdate', 'createdate', 'modifydate'], 'safe'],
            [['prodcode', 'prodname', 'prodename', 'detail', 'photo'], 'string', 'max' => 255],
        ];
    }
