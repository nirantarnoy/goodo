...
class Transline extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['transrefid'], 'exist', 'skipOnError' => true, 'targetClass' => Transtable::className(), 'targetAttribute' => ['transrefid' => 'recid']],
        ];
    }
    ...
    {
        return $this->hasOne(Transtable::className(), ['recid' => 'transrefid']);
    }
}
